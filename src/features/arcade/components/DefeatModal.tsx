...
import { DefeatModalProps } from "../types";
    ...
    <Modal animationType="fade" transparent visible={visible}>
      <View style={styles.overlay}>
        <View style={styles.modalCard}>
          {/* Top Badge */}
          <Badge label="GAME OVER" variant="dark" />

          {/* Icon Shell */}
          <View style={styles.iconShell}>
            <AppIcon color={colors.status.error} name="heart-dislike-outline" size={44} />
          </View>

          {/* Title & Subtitle */}
          <Text style={styles.title}>Out of Lives!</Text>
          <Text style={styles.subtitle}>
            Don't give up! You got {result.correctCount} answers right before running out of lives.
          </Text>
